...
export default function ChatPage() {
  ...
  const handleSearch = async (text) => {
    ...
    try {
      ...
      const response = await generateWeatherIntelligenceResponse(text, currentPersona.id, detectedGeo);
      ...
      const errorMessage = {
        id: `bot-${Date.now()}`,
        sender: 'aeris',
        text: `Unable to retrieve weather intelligence right now: ${error.message}. Please check your connection and try again.`,
        timestamp: new Date().toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit' })
      };
  ...
  return (
    <div className="relative w-full h-full min-h-full bg-[#020b08] flex flex-col justify-between">
      ...
      {isLandingView ? (
        /* ================= CLEAN LANDING VIEW ================= */
        <div className="relative z-10 flex-1 flex flex-col justify-between items-center px-4 sm:px-6 text-center max-w-2xl mx-auto w-full py-6 sm:py-10">
